...
export const SpocBlogPage = () => {
  ...
  const fetchPosts = async () => {
    try {
      setIsLoading(true);
      const response = await api.get("/blog/spoc/my-posts");
  ...
  const handleExport = async () => {
    try {
      setIsExporting(true);
      const response = await api.get("/spoc/export/spoc_blogs", {
        responseType: "blob",
      });
      ...
      link.setAttribute(
        "download",
        `spoc-blogs-${new Date().toISOString().split("T")[0]}.xlsx`,
      );
  ...
  return (
    <PageLayout
      header={
        <PageHeader>
          <div>
            <h1 className="dash-h1 mb-1">My Blog Posts</h1>
      ...
      className="rd-screen rd-screen-spoc-blog"
    >
      ...
      {isLoading ? (
        ...
        <div className="dash-card p-12 text-center">
          ...
          <p className="text-neutral-600 mb-6">
            Start sharing your knowledge and engage with your students by
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Link to={`/spoc/blog/edit/${post.id}`}>
                          <Button variant="ghost" size="sm">
